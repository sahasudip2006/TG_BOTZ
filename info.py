...
BOT_TOKEN = environ.get('BOT_TOKEN', "6777731951:AAE6RRF6doMfJTorNgQxB_JBUgN0KOuJAG4")
...
auth_channel = environ.get( 'AUTH_CHANNEL', '-1001956816026')
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001565949579'))
